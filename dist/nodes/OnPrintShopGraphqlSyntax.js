...
// nodes/OnPrintShopGraphqlSyntax.ts
var OnPrintShopGraphqlSyntax_exports = {};
__export(OnPrintShopGraphqlSyntax_exports, {
  parse: () => import_graphql.parse,
  print: () => import_graphql.print,
  visit: () => import_graphql.visit
});
module.exports = __toCommonJS(OnPrintShopGraphqlSyntax_exports);
