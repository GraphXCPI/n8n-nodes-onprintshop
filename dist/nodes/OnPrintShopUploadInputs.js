...
function addUploadInputs(description) {
    ...
    for (const [operation, type] of Object.entries(uploadTypes)) {
        ...
        description.properties.push({ displayName: 'Input Mode', name: `${operation}_inputMode`, type: 'options', default: 'json', displayOptions,
            options: [{ name: 'JSON Array', value: 'json' }, { name: 'Fields', value: 'fields' }] }, { displayName: 'Entries', name: `${operation}_entries`, type: 'fixedCollection', default: {},
