...
export declare function createOnPrintShopGraphqlClient(context: IExecuteFunctions): Promise<(query: string, variables?: IDataObject, itemIndex?: number, options?: {
    partialDataRoot?: string;
}) => Promise<IDataObject>>;
